 ...
 */
let __ravtextDocxPostUploadFallbackHandlersInstalled = false;

function installDocxPostUploadFallbackHandlers() {
  if (__ravtextDocxPostUploadFallbackHandlersInstalled) return;
  __ravtextDocxPostUploadFallbackHandlersInstalled = true;
