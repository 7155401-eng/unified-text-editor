...
export function startTimeWarningEngine() {
  ...
  // משה 2026-06-05: אם המשתמש בחר במפורש בכפתור "חזרה לדמו" אחרי שהיתרה
  // נגמרה, לא נריץ את מנוע ספירת הזמן בכלל. אחרת מסך הנעילה היה צץ שוב
  // מיד אחרי ה-reload והכפתור היה נראה כאילו הוא פשוט מרענן את עצמו.
