// משה 2026-05-08: שער תצוגה מקדימה לכלים מתורגמים מ-work-files (פייתון).
// כל כלי מתורגם מקבל URL ייחודי על app.ravtext.com:
//   https://app.ravtext.com/?tool=<tool-name>&k=<secret>
// הכלי מופיע רק אם:
//   1. המשתמש מחובר כ-admin (window.__RAVTEXT_AUTH__.admin === true)
//   2. ה-URL מכיל ?tool=<this-tool-name>
//   3. ה-URL מכיל ?k=<PREVIEW_SECRET> (חוסם משתמש שהקליד tool= בלי לדעת)
//
// בלי שלושת התנאים — wireXxx לא נקרא, הכפתור לא מופיע.
