...
// Why: loadSpacingSettings is called frequently during rendering and DOM packing (e.g., checking noMidLineSplitsEnabled).
// Impact: Reduces loadSpacingSettings execution time from ~285ms to ~0.5ms per 10k calls.
