...
const DEFAULTS = {
  ...
  //
  // 2026-05-15 (v2): ברירת מחדל הפכה ל-false. כשהדגל היה דלוק כברירת
  // מחדל, V9 נמנע מ-word-end candidates ודחק חיתוכים למקומות לא
  // טבעיים — שורות חצי-ריקות באמצע פסקה ושבירת משפט "באגדה עשה אזניך
  // / כאפרכסת". עם הדגל כבוי, V9 משתמש בזרימה הטבעית של הדפדפן ואם
  // משתמש רוצה לחסום חיתוכי אמצע-שורה הוא מסמן את ה-checkbox במפורש.
