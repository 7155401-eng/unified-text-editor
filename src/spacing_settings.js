...
// ⚡ Bolt Optimization: Memory cache for spacing settings
// What: Caches the parsed result of localStorage for spacing settings.
// Why: loadSpacingSettings is called frequently during layout calculations (e.g. in dom_packer for every element).
// Impact: Removes repeated synchronous localStorage.getItem and JSON.parse bottlenecks, improving heavy page render performance.
