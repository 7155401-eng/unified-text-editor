...
// Why: loadSpacingSettings is called heavily during rendering and layout loops.
// Impact: Reduces loadSpacingSettings execution time from ~3.5ms to ~0.05ms per 1000 calls.
