...
// 1) Real render cancellation: increment render token and expose a public cancel hook.
patch(
...
patch("src/engine_bridge.js", "cancel after preflight", `    }
    ...
    // v33: inject demo watermarks INTO source content BEFORE pagination —`, "if (myToken !== _renderToken) return;\n\n    // v33: inject demo watermarks INTO source content BEFORE pagination");
...
// 4) Add missing UI safety tools without replacing existing dynamic troubleshooting.
